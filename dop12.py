...
class Country:
    ...
    @property
    def the_name_of_the_continent(self):
        return self.__the_name_of_the_continent

    @property
    def number_of_inhabitant(self):
        return self.__number_of_inhabitant
    ...
    @property
    def the_name_of_the_capital(self):
        return self.__the_name_of_the_capital

    @property
    def the_name_of_the_countrys_cities(self):
        return self.__the_name_of_the_countrys_cities

Ukraine = Country("Україна", "Європа", "41 167 335", "+380", "Київ", "Львів, Херсон, Одеса, Харків")

print("Name country:", Ukraine.name_country)
print("The name of the continent:", Ukraine.the_name_of_the_continent)
print("Number of inhabitant:", Ukraine.number_of_inhabitant)
print("Country code:", Ukraine.country_code)
print("The name of the capital:", Ukraine.the_name_of_the_capital)
print("The name of the country's cities:", Ukraine.the_name_of_the_countrys_cities)